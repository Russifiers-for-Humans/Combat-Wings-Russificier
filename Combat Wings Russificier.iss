...
; Всегда меняются
#define GameName "Combat Wings"                                          ; Название игры
#define GameNameDash "Combat-Wings"                                                          ; Название игры без пробелов
#define GameNameEXE "CombatWings"                                                              ; Название exe файла игры
#define GameVer "1.0"                                                                     ; Версия игры
#define GameAppIdSteam "864450"                                                             ; Ид игры в стиме
; От ситуации зависит
...
[Setup]
; Номер приложения для его удаление лучше все время не забывать разный совать. Проверка уникальный для: Combat Wings Russificier
AppId={{9F743199-E37E-44EE-9ED6-4E9C65854FF4}
...
[Files]
; Ресурсы
Source: {#Location}\{#GameName}\Fix\*;    DestDir: "{app}\movies"; Flags: ignoreversion recursesubdirs createallsubdirs deleteafterinstall
